  ...
  return (
    <section className="mb-16 scroll-mt-20" id="haqqimizda">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
        ...
        {/* Left Column: About Us & Why Us (7 cols) */}
        <div 
          className="lg:col-span-7 p-8 sm:p-10 rounded-3xl border flex flex-col justify-between"
          style={{
        ...
        >
          <div>
            ...
            <div className="space-y-4 text-sm leading-relaxed text-slate-700 font-medium">
              <p>
              ...
              <div className="p-5 rounded-2xl bg-[#fdfaf5] border border-amber-800/10 space-y-2.5">
        ...
        {/* Right Column: Delivery Info Box matching the banner details (5 cols) */}
        <div 
          className="lg:col-span-5 p-8 rounded-3xl border flex flex-col justify-between relative overflow-hidden"
          style={{
        ...
        >
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-2xl flex items-center justify-between gap-4">
                ...
                <span className="px-3 py-1 rounded-lg bg-green-500 text-white text-[11px] font-black uppercase tracking-wider">
                  ÖDƏNİŞSİZ ✓
                </span>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-2xl flex items-center justify-between gap-4">
                ...
                <span className="px-3 py-1 rounded-lg bg-amber-600 text-white text-[11px] font-black uppercase tracking-wider">
                  ƏLAVƏ ÖDƏNİŞLƏ
                </span>
              </div>
            </div>
          ...
          <div className="relative z-10 mt-8 pt-5 border-t border-white/10 space-y-4">
            <div className="flex justify-center gap-4 text-xs font-bold text-white/90 uppercase tracking-widest text-center">
              <span>Təbii</span>
              <span>•</span>
              <span>Saf</span>
              <span>•</span>
